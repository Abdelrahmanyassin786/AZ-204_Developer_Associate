...
namespace StorageQueueApp
{
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string connectionString = Environment.GetEnvironmentVariable("DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=articlea7y;AccountKey=<REMOVED>");
            QueueClient queueClient = new QueueClient("DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=articlea7y;AccountKey=<REMOVED>>", "newsqueue");
