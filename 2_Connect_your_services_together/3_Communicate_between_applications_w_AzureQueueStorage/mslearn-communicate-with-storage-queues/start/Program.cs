...
namespace StorageQueueApp
{
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string connectionString = Environment.GetEnvironmentVariable("STORAGE_CONNECTION_STRING_<REMOVED>");
            QueueClient queueClient = new QueueClient(connectionString/*need to paste the connection string in here also; doesn't read variable*/, "newsqueue");
